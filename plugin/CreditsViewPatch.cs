...
namespace JapaneseMod
{
    ...
    public static class CreditsViewAwakePatch
    {
        ...
        public static void Postfix(ref CreditsView __instance)
        {
            ...
            CreditsViewPatchVariables.EnglishLyrics = __instance.AddNewChildTextView("Lyrics", "", Plugin.BootAssetsReference.AlternateFont, 44, Color.white, TextAlignmentOptions.Center);
            CreditsViewPatchVariables.CommonLyrics = __instance.AddNewChildTextView("Lyrics", "", Plugin.BootAssetsReference.AlternateFont, 44, Color.white, TextAlignmentOptions.Center);
            CreditsViewPatchVariables.JapaneseLyrics = __instance.AddNewChildTextView("Lyrics", "", Plugin.Assets.StoredLanguageFonts.Where(font => font.LanguageCode == Plugin.LANGUAGE_JA_JP && font.Type == FontType.AlternateOutline && font.PatchMode).FirstOrDefault().Font, 44, Color.white, TextAlignmentOptions.Center);

            CreditsViewPatchVariables.TextBg.SetBottomPosition(0);
            CreditsViewPatchVariables.TextBg.SetSize(1920f, 1080 / 100 * 18);

            CreditsViewPatchVariables.EnglishLyrics.SetBottomPosition(1080 / 100 * 8);
            ...
            CreditsViewPatchVariables.CommonLyrics.SetBottomPosition(1080 / 100 * 5);
            ...
            CreditsViewPatchVariables.JapaneseLyrics.SetBottomPosition(1080 / 100 * 2);
        ...
        public static class RunCreditsPatch
        {
            ...
            private static IEnumerator UpdateLyrics(CreditsView instance)
            {
                ...
                CreditsViewPatchVariables.TextBg.ShowOrHideViewOffscreen(false, false, 0, 4.5f, true, null);
